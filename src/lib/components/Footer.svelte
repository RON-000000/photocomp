<script>
	import { Instagram, Twitter, Mail, Heart } from 'lucide-svelte';
</script>
...
<footer class="footer">
	<div class="container">
		...
		<div class="footer-bottom">
			<p class="copyright">
				© {new Date().getFullYear()} PhotoZürich. Alle Rechte vorbehalten.
			</p>
			<p class="made-with">
				Gemacht mit <Heart size={14} class="heart" /> in Zürich
			</p>
		</div>
	</div>
</footer>
