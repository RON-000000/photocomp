...
<div class="voting-panel">
	...
	<div class="jury-section">
		...
		<div class="jury-score">
			<span class="icon">⭐</span>
			<span class="score">{submission.votes.jury.toFixed(1)}</span>
	...
	<div class="info-section">
		<p class="info-text">
			<strong>Hinweis:</strong> Community Votes (60%) und Jury Score (40%) werden kombiniert 
			für das finale Ranking.
		</p>
	</div>
</div>
